...
module.exports = function (format) {
  ...
  format.replace(/%([-_0])?(.)/g, function (_, mod, c, offset) {
    ...
    case 'c': //Date and time representation *
      replaceVal = 'd.toString()';
      break;

    case 'C': //Year divided by 100 and truncated to integer (00-99)
      replaceVal = '__pad2(Math.floor(d.getFullYear() / 100), "' +
        padding + '")';
      break;
  ...
  source = 'function(d) {\n' +
    "var __padZero3 = padZero3, __pad2 = pad2, " +
    "__hours12 = hours12, __weekNumber = weekNumber, " +
    "__l = locale, __d, __p = ''" +
    ';\n' +
    source +
    'return __p;\n}';
  ...
  try {
    /*jshint evil: true */
    result = Function('padZero3', 'pad2', 'hours12',
      'weekNumber', 'locale', 'return ' + source)
      .call(undefined, padZero3, pad2, hours12, weekNumber, DefaultLocale);
  } catch (e) {
    e.source = source;
    throw e;
  }
