...
module.exports = compileTimestamp = function compileTimestamp(format) {
  ...
  function preCompileFormat(format) {
    ...
    argumentValues.push(compileTimestamp(format));
    return name;
  }
